...
lora_model_path=/ssddata/jimmy/ft-model/ft-Qwen2.5-14B
dataset_path=/ssddata/cug-llm-data/sft_qwen2
conversation_template=qwen
output_dir=/ssddata/jimmy/ft-model/sft-Qwen2.5-14B
...
deepspeed --include localhost:0,1,2,3,4,6,7 ${deepspeed_args} \
